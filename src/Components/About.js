        ...
        return (
            <div className="mx-auto" style={{ width: 500 }}>
                <div >
                    ...
                    <div >
                        <ul style={{ margin: 15 }}><h3>About this project:</h3></ul>
                        <li style={{ margin: 15 }}>The three API Calls are made using 'fetch()' so this project is not compatible with Internet Explorer. </li>
                        <li style={{ margin: 15 }}>The three routed links listed in the Navbar each demonstrate a successful Fetch APi to a freely available API.
They are set to catch any errors in the console, so if there seems to be a problem or delay, please check the console for details.</li>
                        <li style={{ margin: 15 }}>Be advised, The Flickr Image Search utilizes a keyword input, and it is possible that the images returned by Flickr are NSFW.</li>
                        <li style={{ margin: 15 }}>There is a section of code in the quoteoftheDay component that is copied and pasted from the provider of the API.  Their documentation included a request that their logo be included in it's use, but I ran into styling issues as they are handled by through React.js.  The code has been commented out, but I left it so I could look into it after the final project is due.</li>
                    </div>
                    <div style={{ margin: 10 }}>
